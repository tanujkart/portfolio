...
export default function HeroSection() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-20 sm:pt-24 md:pt-32 pb-6 sm:pb-8">
      <div className="flex flex-col items-center justify-center">
        <div className="flex flex-col items-center justify-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-bold tracking-tight text-blue-900 text-center drop-shadow-lg px-4" style={{ textShadow: '3px 3px 0 rgba(59, 130, 246, 0.2)' }}>
            {current.name}
          </h1>
          <p className="mt-3 sm:mt-4 text-lg sm:text-xl md:text-2xl lg:text-3xl font-bold text-blue-700/80 transition-all text-center leading-relaxed drop-shadow-sm px-4">
            {displayedText}
            {isTyping && <span className="animate-pulse text-blue-500">|</span>}
          </p>
          <p className="mt-3 sm:mt-4 max-w-3xl text-center text-sm sm:text-base md:text-lg lg:text-xl text-blue-600/80 font-semibold px-4">
          ...
          <div className="mt-6 sm:mt-8 flex gap-2 sm:gap-3">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex h-10 w-10 sm:h-12 sm:w-12 items-center justify-center rounded-lg border-4 border-blue-300 bg-blue-50 text-blue-700 transition-all hover:border-blue-400 hover:bg-blue-100 hover:scale-110 shadow-lg transform"
              aria-label="GitHub"
            >
